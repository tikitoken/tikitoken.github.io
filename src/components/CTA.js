  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <span>{(address !== undefined && address !== '' && address.substring(0, 2) === '0x') ? holdings < 10000 ? address + ' - YOU NEED TO HOLD MORE THAN 10K TIKI TO RECEIVE DIVIDENDS' : address : 'Please enter your address above'}</span>
      </div>
